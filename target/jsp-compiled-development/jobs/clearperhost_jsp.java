...
public class clearperhost_jsp extends HttpJspBase {
 ...
 if(handler.isCrawling()){ 
      ...
      out.write("\n            ");
      out.write("<b class=\"flashMessage\">Cleared cached per-host settings for current job \n            ");
      out.print( cjob.getDisplayName() );
      out.write("</b>\n            ");
      out.write("<p/>\n            Any on-disk changes will take effect at next read.\n            ");
      out.write("<a href=\"javascript:history.back()\">Return to Jobs.");
      out.write("</a>\n        ");
